...
class FixedEmbedding(torch.nn.Embedding):
    """
...
class Embedding(torch.nn.Module):
    ...
    def __init__(self, embedding_size, vocab_size, dropout, enable_cuda=False):
        super(Embedding, self).__init__()
        self.embedding_size = embedding_size
        self.vocab_size = vocab_size
        self.enable_cuda = enable_cuda
        self.embedding_layer = FixedEmbedding(self.vocab_size, self.embedding_size, padding_idx=0, dropout=dropout)
    ...
    def load_emb(self, Eword):
        new = self.embedding_layer.weight.data.new
        self.embedding_layer.weight.data.copy_(new(Eword))
